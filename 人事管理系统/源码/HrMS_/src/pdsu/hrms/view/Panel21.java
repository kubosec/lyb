...
public class Panel21 extends JPanel implements ActionListener{
	...
	private JComboBox<String> tfDept2Name;
...
//		colValue[0][5]="优秀";
		...
		//设置表格的默认大小
		table.setPreferredScrollableViewportSize(new Dimension(200,200));//200,200
		...
		table.addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				tfDept1Name.setText(colValue[row][3]);
				deptinfo = Long.parseLong(colValue[row][6]);
				System.out.println(Long.parseLong(colValue[row][6]));
	...
	lbDept1Name = new JLabel("原部门");
	tfDept1Name = new JTextField(10);
	
	lbDept2Name = new JLabel("新部门");
	//tfDept2Name = new JTextField(10);
	tfDept2Name = new JComboBox<String>();
	...
	public void initBottom() {
		pBottom =  new JPanel();
		btnNextId = new JButton("调入新部门");
		btnNextId.addActionListener(this);
		btnNextId1 = new JButton("清空信息");
