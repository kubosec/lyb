...
//		colValue[0][5]="优秀";
		...
		table.addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				tfDept1Name.setText(colValue[row][5]);
				deptinfo = Long.parseLong(colValue[row][4]);
	...
	public void initCenter() {
		...
		lbDept1Name = new JLabel("上次考核");
		tfDept1Name = new JTextField(10);

		lbDept2Name = new JLabel("本次考核");
		// tfDept2Name = new JTextField(10);
		tfDept2Name = new JComboBox<String>();

		// 为部门下拉列表添加数据
		String[] depts = KaoHistoryDao.getDeptsForSelect();
...
//			person1.setTmp_id(tmp_id);
			...
			history.setNewInfo(itemSize);
			KaoHistoryDao.addHistroy(person1, history);
